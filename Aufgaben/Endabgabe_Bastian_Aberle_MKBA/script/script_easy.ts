...
var randomindex2: number;
var easy: boolean;
var medium: boolean;
var hard: boolean;
var blabla: Bausteine;
var pointCount: number = 0;
var clickCounter: number = 0;
var translateCounter: number = 0;
var intervalIndex: number;
var usedsentence1: string;
var randomindex: number;
var chartCount: number = 0;
var gesamt: number;
var randomindexold: number;

//Array für die Sound Files
var effects: HTMLAudioElement[] = [
...
function intervalCheck(): void {
  intervalIndex = setInterval(checkFinish, 500);
}

//Interface für das Objekt bausteine
interface Bausteine {
  german: string;
  spanisch: string;
  single: string[];
...
function gesamtPunktzahl(): void {
  ...
  var getelement: HTMLElement = document.querySelector("#container_diffs");
...
function checkFinish(): void {
  ...
  if (translateCounter == 5 && difficulty == 1) {
    ...
    const myNode: HTMLElement = document.getElementById("container_buttons");
    myNode.innerHTML = "";
...
function randomSingle(): void {
  ...
  for (let index: number = 0; index < satz[randomindex].single.length; index++) {
    ...
    var getelement: HTMLElement = document.querySelector("#container_buttons");
    getelement.appendChild(newelement);
...
function clicker(): void {
  ...
  function checkOrder1(): void {
    ...
    if (stringClicked1 == stringArray1) {
      ...
      let x: string = document.querySelector(".woerter:hover").getAttribute("id");
      const myNode: HTMLElement = document.getElementById(x);
      myNode.innerHTML = "";
  ...
  function checkOrder2(): void {
    //speichert den gehoverten (geklickten) Text Inhalt in einer Variable ab
    let stringClicked2: string = document.querySelector(".woerter:hover").textContent;
    //speichert die zweite Stelle der richtigen Reihenfolge aus dem Array in einer Variable ab
    let stringArray2: string = satz[randomindex].single[1];
  ...
  function checkOrder3(): void {
    //speichert den gehoverten (geklickten) Text Inhalt in einer Variable ab
    let stringClicked3: string = document.querySelector(".woerter:hover").textContent;
    //speichert die zweite Stelle der richtigen Reihenfolge aus dem Array in einer Variable ab
    let stringArray3: string = satz[randomindex].single[2];
  ...
  function checkOrder4(): void {
    //speichert den gehoverten (geklickten) Text Inhalt in einer Variable ab
    let stringClicked4: string = document.querySelector(".woerter:hover").textContent;
    //speichert die zweite Stelle der richtigen Reihenfolge aus dem Array in einer Variable ab
    let stringArray4: string = satz[randomindex].single[3];
